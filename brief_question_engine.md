...
Inherited — each question surfaces the dollar figure its underlying piece established ($93K in data-attributable chargebacks, $380K in operational waste, etc.). The engine is where all the portfolio's numbers appear on one surface for the first time. That synthesis is itself the demo: "imagine this running on your data."
